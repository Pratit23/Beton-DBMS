    ...
    return (
        <div className={`${classy}`} style={{ padding: "0" }} >
            <div className="birthday">
                ...
                <input type="text" className="month browser-default" placeholder="MM" maxLength="2" pattern="\d*" />
                <span>/</span>
                <input type="text" className="day browser-default" placeholder="DD" maxLength="2" pattern="\d*" />
                <span>/</span>
                <input type="text" className="year browser-default" placeholder="YYYY" maxLength="4" pattern="\d*" />
            </div>
