...
const RefreshHome = () => {
    ...
    useEffect(() => {
        ...
        window.$(document).ready(function () {
            var $top = window.$(".demo__top");
            var $body = window.$(".demo__body");
            var $bg1 = window.$(".svgBg__bg1");
            var $bg2 = window.$(".svgBg__bg2");
            var $bg3 = window.$(".svgBg__bg3");
            ...
            var $leftTrees = window.$(".svgBg__tree.m--left");
            var $rightTrees = window.$(".svgBg__tree.m--right");
            var $planeRotater = window.$(".plane-rotater");
            ...
            */
            var easings = {
                ...
                elasticBig: function (t, b, c, d) {
                    ...
                    var tc = ts * t;
                    return (
                        b + c * (21 * tc * ts + -150 * ts * ts + 250 * tc + -150 * ts + 30 * t)
                    );
                },
            ...
            var clones = {
                clone1: window.$(".item-1").clone(),
                clone2: window.$(".item-2").clone(),
                clone3: window.$(".item-3").clone()
            };

            /* Applies className with padding transition, which shifts content down,
            then it's prepends clone with 0 opacity and absolute position (0,0).
            Then this clone fades in and padding className being removed from $items and
            ...
            */
            ...
            function release() {
                ...
                if (releasePlane) {
                    $plane.addClass("fly"); // adds className to plane with keyframes animation
                    setTimeout(function () {
                        // when animation is over, allow pull events, remove keyframes className and add new clone
                        animating = false;
            ...
            */
            window.$(document).on("mousedown touchstart", ".demo__body", function (e) {
                if (animating) return; // prevents from pulling during the release animation
                var startY = e.pageY || e.originalEvent.touches[0].pageY;

                window.$(document).on("mousemove touchmove", function (e) {
                ...
                window.$(document).on("mouseup touchend", function () {
                    window.$(document).off("mousemove touchmove mouseup touchend");
                    if (!pullDeltaY) return; // prevents from rapid click events
                    release();
                });
            });
            ...
            */
            ...
            window.$(window).on("resize", resizeFn);
        });
            ...
            <div className="demo__top">
                <svg className="demo__top-svgBg" viewBox="0 0 366 256" style={{ position: "relative", top: "-180px" }}>
                    <g className="svgBg__objects">
                        ...
                        <path className="svgBg__bg svgBg__bg3" fill="#416175" d="M0,170 62,160 235,148 305,145 366,153 366,256 0,256z" />
                        <g className="svgBg__tree svgBg__tree-1 m--left" data-id="1">
                            <path className="svgBg__tree-leafs svgBg__tree-part" fill="#389296" d="M54,127 C77,127 62,95 54,63 C46,95 31,127 54,127" />
                        ...
                        <g className="svgBg__tree svgBg__tree-2 m--left" data-id="2">
                            <path className="svgBg__tree-leafs svgBg__tree-part" fill="#389296" d="M67,124 C90,124 75,92 67,59 C59,92 44,124 67,124" />
                        ...
                        <g className="svgBg__tree svgBg__tree-3 m--right" data-id="3">
                            <path className="svgBg__tree-leafs svgBg__tree-part" fill="#389296" d="M264,129 C287,129 272,97 264,64 C256,97 241,129 264,129" />
                        ...
                        <g className="svgBg__tree svgBg__tree-4 m--right" data-id="4">
                            <path className="svgBg__tree-leafs svgBg__tree-part" fill="#207277" d="M287,128 C310,128 295,96 287,63 C279,96 264,128 287,128" />
                        ...
                        <g className="svgBg__tree svgBg__tree-5 m--right" data-id="5">
                            <path className="svgBg__tree-leafs svgBg__tree-part" fill="#389296" d="M313,128 C336,128 321,96 313,63 C305,96 290,128 313,128" />
