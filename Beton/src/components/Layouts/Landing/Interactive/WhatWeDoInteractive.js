                        ...
                        <div className="logo">
                            <svg width="168" height="32" viewBox="0 0 168 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0)">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M5.73989 14.1002C2.94764 11.308 2.2969 7.43161 5.16242 4.56609C8.02795 1.70057 11.9043 2.35131 14.6966 5.14356C14.8827 5.32971 14.8827 5.63151 14.6966 5.81766L6.414 14.1002C6.22785 14.2864 5.92604 14.2864 5.73989 14.1002Z" fill="#2684FF" />
                                    ...
                                    <g mask="url(#mask0)">
                                        ...
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M11.0056 10.409L25.4203 24.8237L15.7057 33.0225L2.23061 19.5474L11.0056 10.409Z" fill="url(#paint0_linear)" />
                                    </g>
                                </g>
                                <defs>
                    ...
                    <div className="right_card card rightCard3" style={{ margin: "0", borderRadius: "0 0 24px 0" }} >
                        <div className="logo">
                            <svg width="194" height="32" viewBox="0 0 194 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0)">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M10.3416 -0.0221634L13.5674 7.22128C10.151 8.76437 7.90687 12.1869 7.90687 16.0231C7.90687 19.8372 10.125 23.2435 13.5116 24.7996L10.2396 32.022C4.06938 29.1868 0.0241699 22.9748 0.0241699 16.0231C0.0241699 9.03094 4.1167 2.78947 10.3416 -0.0221634ZM24.7857 31.9906L21.4829 24.7825C24.8498 23.2178 27.0506 19.8225 27.0506 16.0231C27.0506 12.2111 24.8349 8.80645 21.4511 7.2491L24.7275 0.028738C30.8925 2.86608 34.9333 9.07533 34.9333 16.0231C34.9333 22.9477 30.9195 29.1401 24.7857 31.9906Z" fill="#2684FF" />
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M27.0652 16H34.9479C34.9479 16.0077 34.9479 16.0155 34.9479 16.0232C34.9479 22.9478 30.9341 29.1402 24.8004 31.9907L21.4976 24.7825C24.8644 23.2179 27.0652 19.8226 27.0652 16.0232C27.0652 16.0155 27.0652 16.0077 27.0652 16Z" fill="url(#paint0_linear)" />
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M10.3317 -0.000110626L13.5619 7.19234C10.1408 8.72456 7.89357 12.123 7.89357 15.9322C4.7937 15.991 4.7633 15.962 0 15.9322C0 8.98926 4.09818 2.79173 10.3317 -0.000110626Z" fill="url(#paint1_linear)" />
                                </g>
                                <defs>
