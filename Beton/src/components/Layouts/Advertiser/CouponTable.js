...
const headCells = [
  ...
  { id: 'validity', numeric: true, disablePadding: false, label: 'Validity (month)' },
  { id: 'assigned', numeric: true, disablePadding: false, label: 'Assigned (Yes/No)' },
  { id: 'user', numeric: true, disablePadding: false, label: 'User name' },
];
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right" >{row.userID.name == null ? "-" : row.userID.name}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
